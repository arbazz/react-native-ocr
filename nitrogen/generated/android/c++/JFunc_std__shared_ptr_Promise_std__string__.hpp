...
namespace margelo::nitro::ocr {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/ocr/Func_std__shared_ptr_Promise_std__string__;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/ocr/Func_std__shared_ptr_Promise_std__string___cxx;";
